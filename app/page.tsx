...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-[#0A2530]">
      <main className="relative flex flex-1 w-full max-w-3xl flex-col items-center justify-between overflow-hidden py-24 px-8 sm:px-16 bg-gradient-to-b from-[#123B47] to-[#0A2530] sm:items-start">
